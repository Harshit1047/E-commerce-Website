...
const UpdateProduct = ({ match, history }) => {
  ...
  useEffect(() => {
    if (product && product._id !== productId) {
      ...
      setIsAdvertise(product.isAdvertise);
  ...
  const submitHandler = (e) => {
    ...
    formData.set("isAdvertise", isAdvertise);
          ...
          <Fragment>
            <div className="wrapper my-5">
              ...
              >
                ...
                <div className="form-group">
                  <label htmlFor="advertise_field">Advertise</label>
                  <select
                    className="form-control"
                    id="advertise_field"
                    value={isAdvertise}
                    onChange={(e) => setIsAdvertise(e.target.value)}
                  >          
                    <option>false</option>
                    <option>true</option>
                  </select>
